...
local Observer = MVCClass('Observer')
...
function Observer:CheckNotify()
	if not self.context then
		return false
	end

	if self.context.onCheckNotify then
		return self.context:onCheckNotify()
	end
