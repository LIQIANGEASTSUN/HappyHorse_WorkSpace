...
local util = require 'System.Core.Glue.util'

local go = CS.UnityEngine.GameObject.Find('__EngineRoot__')
local cs_coroutine_runner = go:AddComponent(typeof(CS.Coroutine_Runner))
