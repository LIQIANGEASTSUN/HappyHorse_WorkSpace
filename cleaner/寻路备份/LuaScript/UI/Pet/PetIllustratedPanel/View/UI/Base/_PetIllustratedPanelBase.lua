...
function _PetIllustratedPanelBase:bindView()
	...
	--insertInit
		...
		self.illustratedContent = self.illustrated:Find("ScrollView/Viewport/Content")

		self.battleTeam = self.illustratedContent:Find("BattleTeam")
		self.illustratedType = self.illustratedContent:Find("IllustratedType")

		self.teamEditor = self.gameObject.transform:Find("TeamEditor")
	--insertInitComp
